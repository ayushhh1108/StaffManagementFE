...
function DashBoardPage() {
  ...
  console.log("getLocalStorageData", firstName, lastName);
  return (
    <Box component="main" sx={{ flexGrow: 1, p: 3, mt: 10 }}>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
        <div class="bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group " style={{backgroundColor:"#164e63"}}>
